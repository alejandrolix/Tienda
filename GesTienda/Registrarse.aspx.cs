    ...
    public partial class Registrarse : System.Web.UI.Page
    {
        ...
        protected void btnInsertar_Click(object sender, EventArgs e)
        {
            ...
            if (txtPassword1.Text == txtPassword2.Text)
            {
                ...
                strRol = "U";
                dtFechaAlta = DateTime.Now; // Carga fecha y hora del sistema
                ...
                string strComandoSql_1 = "INSERT USUARIO " + "(Login,Password, Rol, FechaAlta) VALUES (" + "'" + strLogin + "','" + strPassword + "','" + strRol + "','" + strFechaAlta + "');";
                string strComandoSql_2 = "INSERT CLIENTE " + "(IdCliente,NomCli,DirCli,PobCli,CpoCli,TelCli,CorCli) VALUES (" + "'" + strIdCliente + "','" + strNomCli + "','" + strDirCli + "','" + strPobCli + "','" + strCpoCli + "','" + strTelCli + "','" + strCorCli + "');";
