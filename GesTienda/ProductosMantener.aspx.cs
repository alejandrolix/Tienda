...
namespace GesTienda
{
    public partial class ProductosMantener : System.Web.UI.Page
    {
            ...
            using (SqlConnection conexion = new SqlConnection(StrCadenaConexion))
            {
                try
                {
                    ...
                    if (reader.HasRows)
                    {
                        ...
                        ddlIdTipo.SelectedItem.Value = reader.GetString(4);
        ...
        private bool EjecutarSql(string StrComandoSql)
        {
            string StrCadenaConexion = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
            string StrError = "";
        ...
        protected void btnInsertar_Click(object sender, EventArgs e)
        {
            ...
            string StrCadenaConexion = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
            string StrComandoSql = "INSERT PRODUCTO " + "(IdProducto,DesPro,PrePro,IdUnidad,IdTipo) VALUES (" + "'" + strIdProducto + "','" + strDescripcion + "'," + FnComaPorPunto(dcPrecio) + ",'" + strIdUnidad + "','" + strIdTipo + "');";
        ...
        protected void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            strIdUnidad = ddlIdUnidad.SelectedItem.Text;
            strIdTipo = ddlIdTipo.SelectedItem.Value;
            string StrComandoSql = $"UPDATE PRODUCTO SET DesPro = '{strDescripcion}', PrePro = {FnComaPorPunto(dcPrecio)}, IdUnidad = '{strIdUnidad}', IdTipo = '{strIdTipo}' " +
                                   $"WHERE IdProducto = '{strIdProducto}';";            

            bool estaActualizado = EjecutarSql(StrComandoSql);
        ...
        private void RecargarGridViewProductos()
        {
            grdProductos.DataBind(); // Vuelve a enlazar el GridVIew para que se actualicen los datos
            grdProductos.SelectedIndex = -1;
        }
        ...
        protected void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            bool estaEliminado = EjecutarSql(StrComandoSql);
