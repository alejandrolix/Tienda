                ...
                try
                {
                    ...
                    if (reader.HasRows)
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            StrResultado += "<div style='display:table-cell; text-align: right'>" + string.Format("{0:c}", reader.GetValue(4)) + "&nbsp; </div>";
                            StrResultado += "</div>";
                            InNumeroFilas++;
                        }
                        ...
                        lblTotal.Text = "<div> Número pedidos realizados: " + InNumeroFilas + "</div>" + "<div>Importe total de los pedidos realizados por el cliente: " + string.Format("{0:c}", DcTotal) + "</div>";
                    }
                    else
                    {
